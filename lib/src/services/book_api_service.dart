...
class BookService {
  ...
  static Future<BookModel> getBooksBySearch(String book,String maxResult,String orderBy,String filter) async {
    var url = 'https://www.googleapis.com/books/v1/volumes?q="$book"&maxResults=$maxResult&orderBy=$orderBy&filter=$filter';
    final res = await http.get(Uri.parse(url));
